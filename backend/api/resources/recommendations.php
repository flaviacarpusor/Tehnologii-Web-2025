...
switch ($method) {
    ...
    case 'POST':
        ...
        $sql  = "INSERT INTO resources (type, title, url, topic, visibility)
                 VALUES ('recommandations', :title, :url, :topic, :visibility)";
        $stmt = $db->prepare($sql);
        ...
        $stmt->execute();
        echo json_encode(['success' => true, 'message' => 'Recomandare inserată']);
        break;
    ...
    case 'PUT':
        ...
        $sql = "UPDATE resources SET
                ...
                WHERE id = :id AND type='recommandations'";
        $stmt = $db->prepare($sql);
        ...
        $stmt->execute();
        echo json_encode(['success' => true, 'message' => 'Recomandare actualizată']);
        break;
    ...
    case 'DELETE':
        ...
        $stmt->execute();
        echo json_encode(['success' => true, 'message' => 'Recomandare ștearsă']);
        break;
